...
XRD Data Post-Processing Suite - Single crystal diffraction processing
"""
...
class SingleCrystalModule(GUIBase):
    """Single crystal processing module"""
    ...
    def setup_ui(self):
        ...
        tk.Label(text_frame, text="Single Crystal Processing",
                bg=self.colors['card_bg'], fg=self.colors['text_dark'],
                font=('Arial', 16, 'bold')).pack(anchor=tk.W)

        tk.Label(text_frame, text="Process and analyze single crystal X-ray diffraction data",
