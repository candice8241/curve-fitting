...
from prefernce import GUIBase, ModernButton, ModernTab, CuteSheepProgressBar
...
def show_startup_window():
    """Show startup splash screen then launch main application"""
    splash = tk.Tk()
    ...
    splash.configure(bg="#EDE9F3")  # light purple-pink
    ...
    # Automatically close startup window and open the main app after 2 seconds
    splash.after(2000, launch_main)
    splash.mainloop()
