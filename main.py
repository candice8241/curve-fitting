...
class XRDProcessingGUI(GUIBase):
    ...
    def __init__(self, root):
        ...
        # Try to set icon (cross-platform)
        try:
...
def launch_main_app():
    ...
    try:
        app_id = u"xrdprocessing.xrdpostprocessor.v1"
...
def show_startup_window():
    ...
    tk.Label(splash, text="Starting up, please wait...", font=("Arial", 12)).pack(pady=20)
