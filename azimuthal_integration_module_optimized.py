...
Created: Nov 15, 2025
Modified: Nov 16, 2025 - Deep Performance Optimization (Replaced spinners with Entry)
"""
...
# ============================================================================
# GUI Module with DEEP PERFORMANCE OPTIMIZATIONS
# ============================================================================

class AzimuthalIntegrationModule(GUIBase):
    """Azimuthal Integration module - DEEP PERFORMANCE OPTIMIZED VERSION"""
    ...
    def __init__(self, parent, root):
        ...
        self.custom_sectors = []
        self._update_scheduled = False  # Prevent multiple rapid updates
    ...
    def _setup_custom_sectors_mode(self):
        """Custom sectors - DEEP PERFORMANCE OPTIMIZED (Simple Entry instead of Spinner)"""
        ...
        # Sectors list container (stored for efficient updates)
    ...
    def _update_sectors_display(self):
        """DEEP OPTIMIZED: Only update sectors list - Uses simple Entry widgets"""
        ...
        def do_update():
            ...
            # Rebuild only the sectors rows with SIMPLE widgets
            for idx, sector in enumerate(self.custom_sectors):
                ...
                # Start angle - SIMPLE ENTRY (was complex spinner)
                ...
                # End angle - SIMPLE ENTRY (was complex spinner)
        ...
        # Delay update slightly to allow rapid operations to batch
        self.root.after(50, do_update)

    def _add_sector(self):
        """Add sector - OPTIMIZED"""
        new_sector = [
