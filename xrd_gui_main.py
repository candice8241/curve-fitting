...
def launch_main_app():
    ...
    # Try to set AppUserModelID (Windows only)
    try:
        import ctypes
...
def show_startup_window():
    ...
    label_frame = tk.Frame(splash, bg="#F9EBF2", relief="flat", padx=30, pady=30)
    ...
    splash.after(2000, lambda: [splash.destroy(), launch_main_app()])
    splash.mainloop()
