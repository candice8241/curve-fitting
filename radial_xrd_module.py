...
class RadialXRDModule(GUIBase):
    ...
    def _integrate_sector(self, azim_start, azim_end, sector_label):
        """
        Perform integration for a single sector using pyFAI 2025.3.0
        ...
        # Log pyFAI version for debugging
        self.radial_log(f"   Using pyFAI version: {pyFAI.version}")
        ...
        for idx, h5_file in enumerate(input_files):
            ...
            # The method parameter is important - use 'csr' for better compatibility
