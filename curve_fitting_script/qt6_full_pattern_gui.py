...
class FullPatternFittingWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        self.phase_table.setMinimumHeight(90)
        self.phase_table.verticalHeader().setDefaultSectionSize(20)
        self.phase_table.setColumnWidth(0, 140)
        self.phase_table.setColumnWidth(1, 24)
        phase_font = self.phase_table.font()
        phase_font.setPointSize(max(7, phase_font.pointSize() - 2))
        self.phase_table.setFont(phase_font)
        header_font = self.phase_table.horizontalHeader().font()
    ...
    def load_data(self) -> None:
        ...
        self.plot_file_label.setText(f"Data: {os.path.basename(file_path)}")
